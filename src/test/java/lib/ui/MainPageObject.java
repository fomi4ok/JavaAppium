...
public class MainPageObject {
  ...
  public WebElement waitForElementClear(String locator, String error_message,long timeoutInSeconds) {
  ...
  public List<WebElement> waitForListOfElements(String locator) {
  ...
  public void scrollWebPageTillElementNotVisible(String locator, String error_message, int max_swipes) {
    ...
    while (!this.isElementLocatedOnTheScreen(locator)) {
      ...
      if (already_swiped > max_swipes) {
        Assert.assertEquals(error_message, element.isDisplayed());
      }
    }
  }
    ...
    public void tryClickElementWithFewAttempts(String locator, String error_message, int ammount_of_attempts ) {
      ...
      while (need_more_attempts) {
        try {
          ...
          if (current_attempts > ammount_of_attempts) {
          this.waitForElementAndClick(locator, error_message, 1);
        }
      }
      ++current_attempts;
